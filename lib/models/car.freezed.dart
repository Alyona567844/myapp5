...
class _$CarImpl implements _Car {
  ...
  @override
  String toString() {
    return 'Car(brand: $brand, model: $model, color: $color, availability: $availability, price: $price)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, brand, model, color, availability, price);
...
abstract class _Car implements Car {
  factory _Car(
      ...
      @PriceConverter() required final double price}) = _$CarImpl;
